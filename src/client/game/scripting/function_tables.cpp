...
namespace scripting
{
	...
	std::unordered_map<std::string, unsigned> token_map =
	{
		...
		{"lastSlowProcessFrame", 0x55fc},
		{"lastWave", 0x560e},
		{"livesCount", 0x57b9},
		{"mapCenter", 0x5986},
		{"multiTeamBased", 0x5fec},
		{"objectiveBased", 0x62f8},
		{"oneLeftTime ", 0x648b},
		{"otherTeam", 0x65b3},
		{"placement", 0x6861},
		{"tookWeaponFrom", 0x680b},
		{"postRoundTime", 0x68ec},
		{"playersLookingForSafeSpawn", 0x6d59},
		{"showingFinalKillcam", 0x8516},
		{"tiSpawnDelay", 0x93860},
		{"teamBased", 0x91eb},
		{"teamCount", 0x91ed},
		{"tweakablesInitialized", 0x9386},
		{"wasWinning", 0xa1d4},
		{"waveDelay", 0xa2ab},
		...
		{"maps/mp/gametypes/_hostmigration", 0xa7e4},
