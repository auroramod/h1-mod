-- language_setting
localizations["LUA_MENU_LANGUAGE_BUTTON_DESC"] = "ゲーム言語を変更する."
localizations["LUA_MENU_LANGUAGE_POPUP_RESTART_REQUIRED_TEXT"] = "警告: 正しく機能するには、ゲームルートのゾーンディレクトリに言語のゾーンファイルが必要です.\n\nゲーム言語を変更しましたが、再開しますか?"
