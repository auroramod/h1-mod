-- language_setting
localizations["LUA_MENU_LANGUAGE_BUTTON_DESC"] = "Cambia la tua lingua di gioco."
localizations["LUA_MENU_LANGUAGE_POPUP_RESTART_REQUIRED_TEXT"] = "ATTENZIONE: per funzionare correttamente, devi avere i file di zona della tua lingua nella directory zone della tua root di gioco.\n\nHai cambiato la lingua del gioco, desideri riavviare?"
